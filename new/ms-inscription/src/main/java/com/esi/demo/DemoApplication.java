...
public class DemoApplication implements CommandLineRunner {
	...
	@Override
		public void run (String...args) throws Exception {
			...
			etudiantRepository.save(new Etudiant(null, "malki","malki", Date.valueOf("1999-01-01"), Sexe.homme, G1,null));
			etudiantRepository.save(new Etudiant(null, "ali","malki", Date.valueOf("1995-08-11"), Sexe.homme, G2,null));
			etudiantRepository.save(new Etudiant(null, "karim","malki", Date.valueOf("1996-11-22"), Sexe.homme, G11,null));
			etudiantRepository.save(new Etudiant(null, "fouad","malki", Date.valueOf("2000-02-15"), Sexe.homme, G22,null));
