...
public class MsExamenApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Etudiant e1=etudiantRepository.save(new Etudiant(null,14,null));
		Etudiant e2=etudiantRepository.save(new Etudiant(null,15,null));
		...
		Note n1=noteRepository.save(new Note(null,ex1,e1));
		Note n2=noteRepository.save(new Note(null,ex2,e2));
